...
def parse_ucfcrime_splits(level):
    ...
    Returns:
        list: "train", "val", "test" splits of UCF-101.
    """
    class_index_file = '/media/hkuit155/24d4ed16-ee67-4121-8359-66a09cede5e7/AbnormalDetection/DATASET/UCF-crime/ucfcrime_label_map.txt'
    train_file_template = '/media/hkuit155/24d4ed16-ee67-4121-8359-66a09cede5e7/AbnormalDetection/DATASET/UCF-crime/Anomaly_Train.txt'
    test_file_template = '/media/hkuit155/24d4ed16-ee67-4121-8359-66a09cede5e7/AbnormalDetection/DATASET/UCF-crime/Anomaly_Test.txt'
