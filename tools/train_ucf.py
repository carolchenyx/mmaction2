...
def parse_args():
    ...
    parser.add_argument('--config', default='/media/hkuit155/24d4ed16-ee67-4121-8359-66a09cede5e7/AbnormalDetection/mmaction2/configs/recognition/i3d/i3d_nl_dot_product_r50_video_32x2x1_100e_ucf_rgb.py', help='train config file path')
